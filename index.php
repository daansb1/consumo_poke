...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="canal.css">
</head>
<body>
                ...
                <div class="card">
                    <div class="card-image has-text-centered">
                        <figure class="image is-128x128">
                            <img src="<?= $Pokemon->img ?>" alt="<?= $Pokemon->name ?>" class=""
                    ...
                    <div class="card-content has-text-centered">
                        <div class="content">
                            ...
                            <div>
                                ...
                                <h5>Ovo: <?= $Pokemon->egg ?></h5>
                                <h5>Chance de desova: <?= $Pokemon->spawn_chance ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
